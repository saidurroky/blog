...
.actiondel a{background: #f0f0f0;border: 1px solid #ddd; color: #444;cursor: pointer;font-size: 20px;font-weight: normal;padding: 4px 20px;}
         ...
         <form action="" method="post">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <textarea class="tinymce" name="body">value="<?php echo $result['body']?>"</textarea>
                    </td>
                </tr>
